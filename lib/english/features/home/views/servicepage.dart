...
import 'package:smart_home/english/features/home/views/emotionscreen.dart';
import 'package:smart_home/english/features/home/views/deepfake_screen.dart';
import 'package:smart_home/english/features/home/views/intention_screen.dart';
                  ...
                  Row(
                    children: [
                      FadeInSlide(
                        duration: 1.4,
                        child: Text(
                          "Advanced Tools (Including Media)",
                          textAlign: TextAlign.start,
                          style: TextStyle(
                              fontSize: 20, fontWeight: FontWeight.bold),
                        ),
              ...
              child: Row(
                children: [
                  CustomLottieWidget(
                    ...
                    animationPath: "assets/images/media detection.json",
                    text: "Intention Detection",
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => IntentionScreen()));
                      // item['onPressed'](
                      //     context); // Pass context to onPressed function
                    },
                  ),
