...
class _DeepfakeScreenState extends State<DeepfakeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('DeepFake Detection App'),
      ),
      body: Padding(
              ...
              _detected == false
                  ...
                  : Column(
                      children: [
                        ...
                        SizedBox(height: screenWidth * 0.05),
                        Text(
                          'Fake Confidence: ${(_fakeConfidence * 100).toStringAsFixed(2)}%',
                          style: TextStyle(
                            fontSize: screenWidth * 0.05,
                            fontWeight: FontWeight.bold,
                          ),
                        ...
                        SizedBox(height: screenWidth * 0.05),
                        Text(
                          'Real Confidence: ${(_realConfidence * 100).toStringAsFixed(2)}%',
                          style: TextStyle(
                            fontSize: screenWidth * 0.05,
                            fontWeight: FontWeight.bold,
                          ),
                        ...
                        Align(
                          ...
                          child: FilledButton(
                            ...
                            child: Text(
                              "See the detailed analysis of this image.",
  ...
  void request() async {
    LoadingScreen.instance().show(context: context, text: "Detecting...");
    ...
    LoadingScreen.instance()
        .show(context: context, text: "Detected Successfully");
