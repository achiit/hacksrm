      ...
      body: ListView(
        ...
        children: [
          ...
          FadeInSlide(
            duration: .5,
            child: Text(
              "A mail with a link to reset your password will be sent to your registered Email Id.",
              style: context.tm,
            ),
          ),
          ...
          child: FilledButton(
            onPressed: () async {
              LoadingScreen.instance()
                  .show(context: context, text: "Sending Email...");
              ...
              LoadingScreen.instance()
                  .show(context: context, text: "Email Sent Successfully");
              await Future.delayed(const Duration(seconds: 1));
