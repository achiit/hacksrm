...
import 'package:smart_home/tamil/features/home/views/emotiondetailspage.dart';
...
class _ChatAnalyzerScreenState extends State<ChatAnalyzerScreen> {
  ...
  Future<String> _getFileContent() async {
    ...
    try {
      ...
      return content.length > 50 ? content.substring(0, 300) + "..." : content;
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('உணர்ச்சி கண்டுபிடிப்பான்'),
      ),
      bottomNavigationBar: FilledButton(
        onPressed: () async {
          _selectedFile == null && dateTime!.isAfter(dateTime2!)
              ? Fluttertoast.showToast(
                  msg: "கோப்பு எதுவும் தேர்ந்தெடுக்கப்படவில்லை!",
                  toastLength: Toast.LENGTH_SHORT,
                  gravity: ToastGravity.CENTER,
                  timeInSecForIosWeb: 1,
                  textColor: Colors.white,
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: _selectedFile == null
                        ? Column(
                            ...
                            children: [
                              ...
                              Text(
                                'வாட்ஸ்அப்பில் இருந்து ஏற்றுமதி செய்யக்கூடிய .txt கோப்பை இங்கே இழுத்து விடுங்கள்.',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                            ...
                            children: [
                              Align(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "கோப்பு உள்ளடக்கத்தின் முன்னோட்டம்",
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                        fontSize: 30,
                                        fontWeight: FontWeight.bold,
                                    ...
                                    FutureBuilder<String>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return Text(
                                          snapshot.data ??
                                              'எந்த கோப்பும் தேர்வு செய்ய படவில்லை', // Display file content or default message
                                        );
                                      },
                                    ),
                                  ],
              ...
              FadeInSlide(
                duration: 0.4,
                child: Text(
                  "அரட்டைகளை பகுப்பாய்வு செய்ய தொடக்க தேதி மற்றும் தொடக்க நேரத்தைத் தேர்ந்தெடுக்கவும்",
              ...
              FadeInSlide(
                duration: 0.6,
                child: Text(
                  "அரட்டைகளை பகுப்பாய்வு செய்ய முடிவு தேதி மற்றும் முடிவு நேரத்தைத் தேர்ந்தெடுக்கவும்",
                  style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                ),
              ),
              SizedBox(height: 10.0),
  ...
  void request() async {
    LoadingScreen.instance().show(context: context, text: "பகுப்பாய்வு...");
    ...
    LoadingScreen.instance()
        .show(context: context, text: "வெற்றிகரமாக பிரித்தெடுக்கப்பட்டது");
