...
import 'package:smart_home/english/common/clippers.dart';
import 'package:smart_home/english/common/text_style_ext.dart';
import 'package:smart_home/tamil/features/auth/views/get_started_view.dart';
import 'package:smart_home/tamil/features/oboarding/onboarding_data.dart';
...
class _OnboardingViewState extends State<OnboardingView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      //backgroundColor: Color(0xff312c9c),
      body: Column(
        children: [
          Expanded(
                    ...
                    FilledButton(
                      ...
                      style: FilledButton.styleFrom(
                        backgroundColor: isDark
                            ? Color.fromARGB(255, 162, 112, 236)
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: isActive ? AppColors.primaryred : Colors.grey.withOpacity(.3),
          ...
          child: Stack(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: /* theme.colorScheme.primary */ Color(0xfffdf9b3),
                ),
              ),
              Positioned(
                bottom: -30,
